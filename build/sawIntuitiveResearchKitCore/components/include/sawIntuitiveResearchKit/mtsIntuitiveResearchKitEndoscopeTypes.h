...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/sawIntuitiveResearchKit/core/components/code/mtsIntuitiveResearchKitEndoscopeTypes.cdg
...
/* source line: 6 */
class CISST_EXPORT mtsIntuitiveResearchKitEndoscopeTypes
{
...
/* source line: 10 */
public:
    enum Type {SCOPE_ERROR = 0, SCOPE_NONE, SCOPE_Classic_SD_STRAIGHT, SCOPE_Classic_SD_UP, SCOPE_Classic_SD_DOWN, SCOPE_Classic_HD_STRAIGHT, SCOPE_Classic_HD_UP, SCOPE_Classic_HD_DOWN, SCOPE_Si_HD_STRAIGHT, SCOPE_Si_HD_UP, SCOPE_Si_HD_DOWN };
...
/* default functions */
void CISST_EXPORT cmnSerializeRaw(std::ostream & outputStream, const mtsIntuitiveResearchKitEndoscopeTypes & object);
void CISST_EXPORT cmnDeSerializeRaw(std::istream & inputStream, mtsIntuitiveResearchKitEndoscopeTypes & placeHolder);
/* data functions */
...
#if CISST_HAS_JSON
template <> void CISST_EXPORT cmnDataJSON<mtsIntuitiveResearchKitEndoscopeTypes >::SerializeText(const mtsIntuitiveResearchKitEndoscopeTypes & data, Json::Value & jsonValue);
template <> void CISST_EXPORT cmnDataJSON<mtsIntuitiveResearchKitEndoscopeTypes >::DeSerializeText(mtsIntuitiveResearchKitEndoscopeTypes & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON
std::string CISST_EXPORT cmnDataHumanReadable_mtsIntuitiveResearchKitEndoscopeTypes_Type(const mtsIntuitiveResearchKitEndoscopeTypes::Type & data);
