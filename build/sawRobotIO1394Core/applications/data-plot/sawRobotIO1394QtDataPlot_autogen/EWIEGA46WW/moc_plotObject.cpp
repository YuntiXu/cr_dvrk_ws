...
#include <memory>
#include "../../../../../../src/cisst-saw/sawRobotIO1394/core/applications/data-plot/plotObject.h"
...
void plotObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<plotObject *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject plotObject::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_plotObject.data,
    qt_meta_data_plotObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *plotObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_plotObject.stringdata0))
