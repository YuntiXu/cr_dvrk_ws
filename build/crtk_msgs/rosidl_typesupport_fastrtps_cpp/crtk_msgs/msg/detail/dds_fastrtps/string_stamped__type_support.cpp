...
#include "crtk_msgs/msg/detail/string_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crtk_msgs::msg::StringStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crtk_msgs::msg::StringStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtk_msgs::msg::StringStamped;
    is_plain =
      (
      offsetof(DataType, string) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const crtk_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crtk_msgs::msg::StringStamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<crtk_msgs::msg::StringStamped>()
{
  return &crtk_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crtk_msgs, msg, StringStamped)() {
  return &crtk_msgs::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
