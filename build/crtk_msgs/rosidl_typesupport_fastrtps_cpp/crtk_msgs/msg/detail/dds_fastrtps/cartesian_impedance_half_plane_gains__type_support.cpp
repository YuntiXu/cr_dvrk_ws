...
#include "crtk_msgs/msg/detail/cartesian_impedance_half_plane_gains__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crtk_msgs::msg::CartesianImpedanceHalfPlaneGains & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crtk_msgs::msg::CartesianImpedanceHalfPlaneGains & ros_message)
{
  // Member: p
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crtk_msgs::msg::CartesianImpedanceHalfPlaneGains;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crtk_msgs::msg::CartesianImpedanceHalfPlaneGains *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crtk_msgs::msg::CartesianImpedanceHalfPlaneGains *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CartesianImpedanceHalfPlaneGains__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crtk_msgs::msg::CartesianImpedanceHalfPlaneGains *>(
...
static size_t _CartesianImpedanceHalfPlaneGains__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CartesianImpedanceHalfPlaneGains(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CartesianImpedanceHalfPlaneGains__callbacks = {
  "crtk_msgs::msg",
...
static rosidl_message_type_support_t _CartesianImpedanceHalfPlaneGains__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CartesianImpedanceHalfPlaneGains__callbacks,
...
{
  return &crtk_msgs::msg::typesupport_fastrtps_cpp::_CartesianImpedanceHalfPlaneGains__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crtk_msgs, msg, CartesianImpedanceHalfPlaneGains)() {
  return &crtk_msgs::msg::typesupport_fastrtps_cpp::_CartesianImpedanceHalfPlaneGains__handle;
}
