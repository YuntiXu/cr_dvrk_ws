...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmConfigurationJoint.cdg
...
void prmConfigurationJoint::Copy(const prmConfigurationJoint & source__cdg) {
    ...
    cmnData<vctDynamicVector<cmnJointType> >::Copy(this->mType, source__cdg.mType);
...
void prmConfigurationJoint::SerializeBinary(std::ostream & outputStream__cdg) const CISST_THROW(std::runtime_error) {
    ...
    cmnData<vctDynamicVector<cmnJointType> >::SerializeBinary(this->mType, outputStream__cdg);
...
void prmConfigurationJoint::DeSerializeBinary(std::istream & inputStream__cdg,
    ...
    cmnData<vctDynamicVector<cmnJointType> >::DeSerializeBinary(this->mType, inputStream__cdg, localFormat, remoteFormat);
...
void prmConfigurationJoint::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const CISST_THROW(std::runtime_error) {
    ...
    someData__cdg = true;
    cmnData<vctDynamicVector<cmnJointType> >::SerializeText(this->mType, outputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
    someData__cdg = true;
...
std::string prmConfigurationJoint::SerializeDescription(const char delimiter__cdg, const std::string & userDescription__cdg) const {
    ...
    someData__cdg = true;
    description__cdg << cmnData<vctDynamicVector<cmnJointType> >::SerializeDescription(this->mType, delimiter__cdg, prefix__cdg + "Type");
    if (someData__cdg) {
        description__cdg << delimiter__cdg;
    }
    someData__cdg = true;
...
void prmConfigurationJoint::DeSerializeText(std::istream & inputStream__cdg,
    ...
    someData__cdg = true;
    cmnData<vctDynamicVector<cmnJointType> >::DeSerializeText(this->mType, inputStream__cdg, delimiter__cdg);
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "prmConfigurationJoint");
    }
    someData__cdg = true;
...
std::string prmConfigurationJoint::HumanReadable(void) const {
    ...
    description__cdg << "  Type:" << cmnData<vctDynamicVector<cmnJointType> >::HumanReadable(this->mType);
...
bool prmConfigurationJoint::ScalarNumberIsFixed(void) const {
    return true
           ...
           && cmnData<vctDynamicVector<cmnJointType> >::ScalarNumberIsFixed(this->mType)
...
size_t prmConfigurationJoint::ScalarNumber(void) const {
    return 0
           ...
           + cmnData<vctDynamicVector<cmnJointType> >::ScalarNumber(this->mType)
...
std::string prmConfigurationJoint::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const CISST_THROW(std::out_of_range) {
    ...
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<vctDynamicVector<cmnJointType> >::ScalarNumber(this->mType);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<vctDynamicVector<cmnJointType> >::ScalarDescription(this->mType, index_cdg - baseIndex__cdg, prefix__cdg + "Type");
    }
    baseIndex__cdg = currentMaxIndex__cdg;
...
double prmConfigurationJoint::Scalar(const size_t index_cdg) const CISST_THROW(std::out_of_range) {
    ...
    currentMaxIndex__cdg += cmnData<vctDynamicVector<cmnJointType> >::ScalarNumber(this->mType);
    if (index_cdg < currentMaxIndex__cdg) {
        return cmnData<vctDynamicVector<cmnJointType> >::Scalar(this->mType, index_cdg - baseIndex__cdg);
    }
    baseIndex__cdg = currentMaxIndex__cdg;
    currentMaxIndex__cdg += cmnData<vctDynamicVector<double> >::ScalarNumber(this->mPositionMin);
    if (index_cdg < currentMaxIndex__cdg) {
...
void prmConfigurationJoint::SerializeTextJSON(Json::Value & jsonValue) const {
    ...
    cmnDataJSON<vctDynamicVector<cmnJointType> >::SerializeText(this->mType, jsonValue["Type"]);
...
void prmConfigurationJoint::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    ...
    if (!field__cdg.empty()) {
        cmnDataJSON<vctDynamicVector<cmnJointType> >::DeSerializeText(this->mType, field__cdg);
    } else {
        cmnThrow("cmnDataJson<vctDynamicVector<cmnJointType>>::DeSerializeText: empty JSON value for: mType");
    };
