...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmPositionJointSet.cdg
...
prmPositionJointSet::prmPositionJointSet(void):
    ...
    , mAcceleration(vctDynamicVector<double>())
    , mTimeLimit(0.0)
    , mIsCoordinated(true)
    , mDeceleration(vctDynamicVector<double>())
