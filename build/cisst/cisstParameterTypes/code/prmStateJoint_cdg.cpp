...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmStateJoint.cdg
...
prmStateJoint::prmStateJoint(void):
    mtsGenericObject()
    , mName(vctDynamicVector<std::string>())
    , mPosition(vctDynamicVector<double>())
    , mVelocity(vctDynamicVector<double>())
    , mEffort(vctDynamicVector<double>())
{}
