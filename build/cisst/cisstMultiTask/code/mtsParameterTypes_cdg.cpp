...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstMultiTask/code/../mtsParameterTypes.cdg
...
#if CISST_HAS_JSON
  CMN_IMPLEMENT_DATA_FUNCTIONS_JSON_FOR_ENUM_AS_STRING(mtsComponentStatusControl::ComponentStatusCommand, mtsComponentStatusControl::ComponentStatusCommandToString, mtsComponentStatusControl::ComponentStatusCommandFromString);
#endif // CISST_HAS_JSON
...
CMN_IMPLEMENT_SERVICES_TEMPLATED(mtsComponentConstructorArgProxy);

mtsComponentConstructorArg::mtsComponentConstructorArg(void):
    mtsGenericObject()
    , Name()
{}

mtsComponentConstructorArg::mtsComponentConstructorArg(const mtsComponentConstructorArg & other):
    mtsGenericObject(other)
    , Name(other.Name)
{}

mtsComponentConstructorArg & mtsComponentConstructorArg::operator = (const mtsComponentConstructorArg & other)
{
...
mtsComponentConstructorArg::mtsComponentConstructorArg(const std::string & newName):
    mtsGenericObject()
    , Name(newName)
{}
...
void mtsComponentConstructorArg::SerializeRaw(std::ostream & outputStream__cdg) const
{
...
void mtsComponentConstructorArg::DeSerializeRaw(std::istream & inputStream__cdg)
{
...
void mtsComponentConstructorArg::ToStream(std::ostream & outputStream__cdg) const
{
    outputStream__cdg << this->HumanReadable();
}

void mtsComponentConstructorArg::ToStreamRaw(std::ostream & outputStream__cdg, const char delimiter__cdg, bool headerOnly__cdg, const std::string & headerPrefix__cdg) const
{
    if (headerOnly__cdg) {
        outputStream__cdg << cmnData<mtsComponentConstructorArg >::SerializeDescription(*this, delimiter__cdg, headerPrefix__cdg);
    } else {
        cmnData<mtsComponentConstructorArg >::SerializeText(*this, outputStream__cdg, delimiter__cdg);
    }
}
/* source line: 338 */
/* default functions */
void cmnSerializeRaw(std::ostream & outputStream, const mtsComponentConstructorArg & object)
{
    object.SerializeRaw(outputStream);
}
void cmnDeSerializeRaw(std::istream & inputStream, mtsComponentConstructorArg & placeHolder)
{
    placeHolder.DeSerializeRaw(inputStream);
}
/* data functions */
void mtsComponentConstructorArg::Copy(const mtsComponentConstructorArg & source__cdg) {
    cmnData<mtsGenericObject >::Copy(*this, source__cdg);
    cmnData<std::string >::Copy(this->Name, source__cdg.Name);
}
void mtsComponentConstructorArg::SerializeBinary(std::ostream & outputStream__cdg) const CISST_THROW(std::runtime_error) {
...
void mtsComponentConstructorArg::DeSerializeBinary(std::istream & inputStream__cdg,
                                            const cmnDataFormat & localFormat,
                                            const cmnDataFormat & remoteFormat) CISST_THROW(std::runtime_error) {
...
void mtsComponentConstructorArg::SerializeText(std::ostream & outputStream__cdg, const char delimiter__cdg) const CISST_THROW(std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        outputStream__cdg << delimiter__cdg;
    }
...
std::string mtsComponentConstructorArg::SerializeDescription(const char delimiter__cdg, const std::string & userDescription__cdg) const {
    bool someData__cdg = false;
    const std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    std::stringstream description__cdg;
    if (someData__cdg) {
...
void mtsComponentConstructorArg::DeSerializeText(std::istream & inputStream__cdg,
                                          const char delimiter__cdg) CISST_THROW(std::runtime_error) {
    bool someData__cdg = false;
    if (someData__cdg) {
        cmnDataDeSerializeTextDelimiter(inputStream__cdg, delimiter__cdg, "mtsComponentConstructorArg");
    }
    someData__cdg = true;
...
std::string mtsComponentConstructorArg::HumanReadable(void) const {
    std::stringstream description__cdg;
    description__cdg << "mtsComponentConstructorArg" << std::endl;
...
bool mtsComponentConstructorArg::ScalarNumberIsFixed(void) const {
    return true
           && cmnData<mtsGenericObject >::ScalarNumberIsFixed(*this)
           && cmnData<std::string >::ScalarNumberIsFixed(this->Name)
    ;
}
size_t mtsComponentConstructorArg::ScalarNumber(void) const {
    return 0
           + cmnData< mtsGenericObject >::ScalarNumber(*this)
           + cmnData<std::string >::ScalarNumber(this->Name)
    ;
}
std::string mtsComponentConstructorArg::ScalarDescription(const size_t index_cdg, const std::string & userDescription__cdg) const CISST_THROW(std::out_of_range) {
    std::string prefix__cdg = (userDescription__cdg == "") ? "" : (userDescription__cdg + ".");
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    ...
    baseIndex__cdg = currentMaxIndex__cdg;
    cmnThrow(std::out_of_range("cmnDataScalarDescription: mtsComponentConstructorArg index out of range"));
    return "";
}
double mtsComponentConstructorArg::Scalar(const size_t index_cdg) const CISST_THROW(std::out_of_range) {
    size_t baseIndex__cdg = 0;
    size_t currentMaxIndex__cdg = 0;
    currentMaxIndex__cdg += cmnData<mtsGenericObject >::ScalarNumber(*this);
    if (index_cdg < currentMaxIndex__cdg) {
    ...
    baseIndex__cdg = currentMaxIndex__cdg;
    cmnThrow(std::out_of_range("cmnDataScalar: mtsComponentConstructorArg index out of range"));
    return 1.2345;
}
#if CISST_HAS_JSON
template <>
void cmnDataJSON<mtsComponentConstructorArg >::SerializeText(const mtsComponentConstructorArg & data, Json::Value & jsonValue) {
    data.SerializeTextJSON(jsonValue);
}
void mtsComponentConstructorArg::SerializeTextJSON(Json::Value & jsonValue) const {
...
template<>
void cmnDataJSON<mtsComponentConstructorArg >::DeSerializeText(mtsComponentConstructorArg & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
    data.DeSerializeTextJSON(jsonValue);
}
void mtsComponentConstructorArg::DeSerializeTextJSON(const Json::Value & jsonValue) CISST_THROW(std::runtime_error) {
