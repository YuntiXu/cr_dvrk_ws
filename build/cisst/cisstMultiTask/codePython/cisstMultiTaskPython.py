...
class mtsCommandVoid(mtsCommandBase):
    ...
    def Execute(self, *args):
        r"""
        Execute(mtsCommandVoid self, mtsBlockingType arg2) -> mtsExecutionResult
        Execute(mtsCommandVoid self, mtsBlockingType blocking, mtsCommandWriteBase arg3) -> mtsExecutionResult
        """
...
class mtsCommandVoidReturn(mtsCommandBase):
    ...
    def Execute(self, *args):
        ...
        Execute(mtsCommandVoidReturn self, mtsGenericObject result, mtsCommandWriteBase arg3) -> mtsExecutionResult
        """
...
class mtsCommandRead(mtsCommandBase):
    ...
    def Execute(self, *args):
        ...
        Execute(mtsCommandRead self, mtsGenericObject argument, mtsCommandWriteBase arg3) -> mtsExecutionResult
        """
...
class mtsCommandWriteBase(mtsCommandBase):
    ...
    def Execute(self, *args):
        ...
        Execute(mtsCommandWriteBase self, mtsGenericObject argument, mtsBlockingType blocking, mtsCommandWriteBase arg4) -> mtsExecutionResult
        """
...
class mtsCommandWriteReturn(mtsCommandBase):
    ...
    def Execute(self, *args):
        ...
        Execute(mtsCommandWriteReturn self, mtsGenericObject argument, mtsGenericObject result, mtsCommandWriteBase arg4) -> mtsExecutionResult
        """
...
class mtsCommandQualifiedRead(mtsCommandBase):
    ...
    def Execute(self, *args):
        ...
        Execute(mtsCommandQualifiedRead self, mtsGenericObject argument1, mtsGenericObject argument2, mtsCommandWriteBase arg4) -> mtsExecutionResult
        """
...
def mtsObjectName(*args):
    r"""
    mtsObjectName(void const * arg1) -> std::string
...
class mtsInterfaceProvided(mtsInterface):
    ...
    def GetCommandWriteArgumentServices(self, commandName):
        r"""GetCommandWriteArgumentServices(mtsInterfaceProvided self, std::string const & commandName) -> cmnClassServicesBase"""
        return _cisstMultiTaskPython.mtsInterfaceProvided_GetCommandWriteArgumentServices(self, commandName)

    def GetCommandReadArgumentServices(self, commandName):
        r"""GetCommandReadArgumentServices(mtsInterfaceProvided self, std::string const & commandName) -> cmnClassServicesBase"""
        return _cisstMultiTaskPython.mtsInterfaceProvided_GetCommandReadArgumentServices(self, commandName)
...
class mtsTask(mtsComponent):
    ...
    def Configure(self, *args):
        r"""Configure(mtsTask self, std::string const & arg2="")"""
...
class mtsManagerLocal(mtsManagerLocalInterface):
    ...
    def GetProcessName(self, *args):
        r"""GetProcessName(mtsManagerLocal self, std::string const & arg2="") -> std::string const"""
    ...
    def GetNamesOfCommands(self, *args):
        r"""GetNamesOfCommands(mtsManagerLocal self, mtsStringVector namesOfCommands, std::string const & componentName, std::string const & providedInterfaceName, std::string const & arg5="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetNamesOfCommands(self, *args)

    def GetNamesOfEventGenerators(self, *args):
        r"""GetNamesOfEventGenerators(mtsManagerLocal self, mtsStringVector namesOfEventGenerators, std::string const & componentName, std::string const & providedInterfaceName, std::string const & arg5="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetNamesOfEventGenerators(self, *args)

    def GetNamesOfFunctions(self, *args):
        r"""GetNamesOfFunctions(mtsManagerLocal self, mtsStringVector namesOfFunctions, std::string const & componentName, std::string const & requiredInterfaceName, std::string const & arg5="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetNamesOfFunctions(self, *args)

    def GetNamesOfEventHandlers(self, *args):
        r"""GetNamesOfEventHandlers(mtsManagerLocal self, mtsStringVector namesOfEventHandlers, std::string const & componentName, std::string const & requiredInterfaceName, std::string const & arg5="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetNamesOfEventHandlers(self, *args)

    def GetDescriptionOfCommand(self, *args):
        r"""GetDescriptionOfCommand(mtsManagerLocal self, std::string & description, std::string const & componentName, std::string const & providedInterfaceName, std::string const & commandName, std::string const & arg6="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetDescriptionOfCommand(self, *args)

    def GetDescriptionOfEventGenerator(self, *args):
        r"""GetDescriptionOfEventGenerator(mtsManagerLocal self, std::string & description, std::string const & componentName, std::string const & providedInterfaceName, std::string const & eventGeneratorName, std::string const & arg6="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetDescriptionOfEventGenerator(self, *args)

    def GetDescriptionOfFunction(self, *args):
        r"""GetDescriptionOfFunction(mtsManagerLocal self, std::string & description, std::string const & componentName, std::string const & requiredInterfaceName, std::string const & functionName, std::string const & arg6="")"""
        return _cisstMultiTaskPython.mtsManagerLocal_GetDescriptionOfFunction(self, *args)

    def GetDescriptionOfEventHandler(self, *args):
        r"""GetDescriptionOfEventHandler(mtsManagerLocal self, std::string & description, std::string const & componentName, std::string const & requiredInterfaceName, std::string const & eventHandlerName, std::string const & arg6="")"""
...
class mtsComponentConstructorArg(mtsGenericObject):
    r"""Proxy of C++ mtsComponentConstructorArg class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _cisstMultiTaskPython.delete_mtsComponentConstructorArg
    Name = property(_cisstMultiTaskPython.mtsComponentConstructorArg_Name_get, _cisstMultiTaskPython.mtsComponentConstructorArg_Name_set, doc=r"""Name : std::string""")
    HAS_DYNAMIC_CREATION = _cisstMultiTaskPython.mtsComponentConstructorArg_HAS_DYNAMIC_CREATION
    
    InitialLoD = _cisstMultiTaskPython.mtsComponentConstructorArg_InitialLoD
    

    @staticmethod
    def ClassServices():
        r"""ClassServices() -> cmnClassServicesBase"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_ClassServices()

    def __init__(self, *args):
        r"""
        __init__(mtsComponentConstructorArg self) -> mtsComponentConstructorArg
        __init__(mtsComponentConstructorArg self, mtsComponentConstructorArg other) -> mtsComponentConstructorArg
        __init__(mtsComponentConstructorArg self, std::string const & newName) -> mtsComponentConstructorArg
        """
        _cisstMultiTaskPython.mtsComponentConstructorArg_swiginit(self, _cisstMultiTaskPython.new_mtsComponentConstructorArg(*args))

    def Copy(self, source):
        r"""Copy(mtsComponentConstructorArg self, mtsComponentConstructorArg source)"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_Copy(self, source)

    def SerializeBinary(self, outputStream):
        r"""SerializeBinary(mtsComponentConstructorArg self, ostream outputStream)"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_SerializeBinary(self, outputStream)

    def DeSerializeBinary(self, inputStream, localFormat, remoteFormat):
        r"""DeSerializeBinary(mtsComponentConstructorArg self, istream inputStream, cmnDataFormat const & localFormat, cmnDataFormat const & remoteFormat)"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_DeSerializeBinary(self, inputStream, localFormat, remoteFormat)

    def SerializeText(self, *args):
        r"""SerializeText(mtsComponentConstructorArg self, ostream outputStream, char const delimiter=',')"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_SerializeText(self, *args)

    def SerializeDescription(self, *args):
        r"""SerializeDescription(mtsComponentConstructorArg self, char const delimiter=',', std::string const & userDescription="") -> std::string"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_SerializeDescription(self, *args)

    def DeSerializeText(self, *args):
        r"""DeSerializeText(mtsComponentConstructorArg self, istream inputStream, char const delimiter=',')"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_DeSerializeText(self, *args)

    def __str__(self):
        r"""__str__(mtsComponentConstructorArg self) -> std::string"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg___str__(self)

    def ScalarDescription(self, *args):
        r"""ScalarDescription(mtsComponentConstructorArg self, size_t const index, std::string const & userDescription="") -> std::string"""
        return _cisstMultiTaskPython.mtsComponentConstructorArg_ScalarDescription(self, *args)

# Register mtsComponentConstructorArg in _cisstMultiTaskPython:
_cisstMultiTaskPython.mtsComponentConstructorArg_swigregister(mtsComponentConstructorArg)

def mtsComponentConstructorArg_ClassServices():
    r"""mtsComponentConstructorArg_ClassServices() -> cmnClassServicesBase"""
    return _cisstMultiTaskPython.mtsComponentConstructorArg_ClassServices()
