...
QT_INIT_METAOBJECT const QMetaObject mtsQtScaleAndSignalTool::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_mtsQtScaleAndSignalTool.data,
    qt_meta_data_mtsQtScaleAndSignalTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void mtsQtScaleEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<mtsQtScaleEditor *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mtsQtScaleEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QTreeWidget::staticMetaObject>(),
    qt_meta_stringdata_mtsQtScaleEditor.data,
    qt_meta_data_mtsQtScaleEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
