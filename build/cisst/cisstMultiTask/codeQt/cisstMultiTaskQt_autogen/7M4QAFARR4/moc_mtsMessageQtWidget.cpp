...
void mtsMessageQtWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<mtsMessageQtWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (mtsMessageQtWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mtsMessageQtWidget::SignalAppendMessage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (mtsMessageQtWidget::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mtsMessageQtWidget::SignalSetColor)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (mtsMessageQtWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mtsMessageQtWidget::SignalClear)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject mtsMessageQtWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QTextEdit::staticMetaObject>(),
    qt_meta_stringdata_mtsMessageQtWidget.data,
    qt_meta_data_mtsMessageQtWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject mtsMessageQtWidgetComponent::staticMetaObject = { {
    QMetaObject::SuperData::link<mtsMessageQtWidget::staticMetaObject>(),
    qt_meta_stringdata_mtsMessageQtWidgetComponent.data,
    qt_meta_data_mtsMessageQtWidgetComponent,
    qt_static_metacall,
    nullptr,
    nullptr
} };
