...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmActuatorJointCoupling.cdg
...
class CISST_EXPORT prmActuatorJointCoupling
{
 ...
 public:
    ...
    prmActuatorJointCoupling & operator = (const prmActuatorJointCoupling & other);
...
template <> void CISST_EXPORT cmnDataJSON<prmActuatorJointCoupling >::DeSerializeText(prmActuatorJointCoupling & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON
