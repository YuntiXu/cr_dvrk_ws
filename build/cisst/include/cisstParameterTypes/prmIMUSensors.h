...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmIMUSensors.cdg
...
class CISST_EXPORT prmIMUSensors: public mtsGenericObject
{
 ...
 public:
    ...
    prmIMUSensors & operator = (const prmIMUSensors & other);
    ~prmIMUSensors();
...
template <> void CISST_EXPORT cmnDataJSON<prmIMUSensors >::DeSerializeText(prmIMUSensors & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON
