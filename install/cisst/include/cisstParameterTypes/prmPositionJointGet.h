...
// cisst version: 1.3.1
// source file: /home/ytxu/cr_dvrk_ws/src/cisst-saw/cisst/cisstParameterTypes/code/../prmPositionJointGet.cdg
...
class CISST_EXPORT prmPositionJointGet: public mtsGenericObject
{
 ...
 public:
    ...
    prmPositionJointGet & operator = (const prmPositionJointGet & other);
    ~prmPositionJointGet();
...
template <> void CISST_EXPORT cmnDataJSON<prmPositionJointGet >::DeSerializeText(prmPositionJointGet & data, const Json::Value & jsonValue) CISST_THROW(std::runtime_error);
#endif // CISST_HAS_JSON
