...
class FpgaIO(BoardIO):
    ...
    def WaitRTL8211F_Idle(self, callerName, chan, loop_cnt):
        return _Amp1394Python.FpgaIO_WaitRTL8211F_Idle(self, callerName, chan, loop_cnt)
    ...
    def ReadFirewirePhy(self, addr, data):
        return _Amp1394Python.FpgaIO_ReadFirewirePhy(self, addr, data)

    def WriteFirewirePhy(self, addr, data):
        return _Amp1394Python.FpgaIO_WriteFirewirePhy(self, addr, data)
