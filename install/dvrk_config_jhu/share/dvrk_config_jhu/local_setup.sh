...
: ${AMENT_CURRENT_PREFIX:="/home/ytxu/cr_dvrk_ws/install/dvrk_config_jhu"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dvrk_config_jhu/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dvrk_config_jhu/environment/path.sh"
